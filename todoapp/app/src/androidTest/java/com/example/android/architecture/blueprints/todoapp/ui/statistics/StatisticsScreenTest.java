...
public class StatisticsScreenTest {
    ...
    public void setup() {
        ...
        App.inst().getAppComponent().getTaskListModel().add(TestAppModule.LOCAL_TASKITEM_0_ACTIVE);
        App.inst().getAppComponent().getTaskListModel().add(TestAppModule.LOCAL_TASKITEM_1_COMPLETE);
